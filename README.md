...
1. This repository also has some baked in merge conflicts for practice. 
2. This repository is also being used as a part of GitHub training, to practice Git and GitHub.
